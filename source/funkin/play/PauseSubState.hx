...
class PauseSubState extends MusicBeatSubState
{
  ...
  static final PAUSE_MENU_ENTRIES_STANDARD:Array<PauseMenuEntry> = [
    {text: 'Continue Playing', callback: resume},
    {text: 'Begin From Song Beginning', callback: restartPlayState},
    {text: 'Set Another Difficulty', callback: switchMode.bind(_, Difficulty)},
    {text: 'Practice Mode (OFF)', callback: enablePracticeMode, filter: () -> !(PlayState.instance?.isPracticeMode ?? false)},
    {text: 'Exit', callback: quitToMenu},
  ];
  ...
  static final PAUSE_MENU_ENTRIES_CHARTING:Array<PauseMenuEntry> = [
    {text: 'Continue Playing', callback: resume},
    {text: 'Begin From Song Beginning', callback: restartPlayState},
    {text: 'Back to Chart Editor', callback: quitToChartEditor},
  ];
  ...
  static final PAUSE_MENU_ENTRIES_VIDEO_CUTSCENE:Array<PauseMenuEntry> = [
    {text: 'Continue playing cutscene', callback: resume},
    {text: 'Force Cutscene Skip', callback: skipVideoCutscene},
    {text: 'Start Cutscene From Beginning', callback: restartVideoCutscene},
    {text: 'Exit', callback: quitToMenu},
  ];

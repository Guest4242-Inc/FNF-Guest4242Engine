...
class Main extends Sprite
{
  ...
  {
    // To enable the ghost tapping flag, you need to compile with -DFEATURE_GHOST_TAPPING
  ...
  /**
   * A text displayed at the bottom right showing the engine name.
   */
  public static var engineText:Watermark;

  static var ENGINE_TEXT:String = "Guest4242 Engine";
